                ...
                function (require, module, exports) {
                    (function (global) {
                        ...
                        function dragula(initialContainers, options) {
                            ...
                            if (
                                len === 1 &&
                                Array.isArray(initialContainers) === false
                            ) {
                            ...
                            function startBecauseMouseMoved(e) {
                                ...
                                if (
                                    e.clientX !== void 0 &&
                                    Math.abs(e.clientX - _moveX) <=
                                        (o.slideFactorX || 0) &&
                                    e.clientY !== void 0 &&
                                    Math.abs(e.clientY - _moveY) <=
                                        (o.slideFactorY || 0)
                                ) {
                                    return;
                                }
                            ...
                            function start(context) {
                                ...
                                _item = context.item;
                                _initialSibling = _currentSibling = nextEl(
                                    context.item
                                );
                            ...
                            function findDropTarget(
                                ...
                                function accepted() {
                                    ...
                                    var initial = isInitialPlacement(
                                        target,
                                        reference
                                    );
                                    if (initial) {
                            ...
                            function renderMirrorImage() {
                                ...
                                _mirror.style.height =
                                    getRectHeight(rect) + "px";
                        ...
                        function getOffset(el) {
                            ...
                            return {
                                left:
                                    rect.left +
                                    getScroll("scrollLeft", "pageXOffset"),
                                top:
                                    rect.top +
                                    getScroll("scrollTop", "pageYOffset"),
                            };
                        }
